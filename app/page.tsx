...
// import ScheduleImage from '@/public/images/Mat2.png'
...
export default function Page() {
	useEffect(() => {
		...
		var countDownDate = new Date("Nov 1, 2024 23:59:00").getTime();
	...
	return (
		<>	
			...
			<div className="flex flex-col justify-around text-center bg-black font-garet text-white pt-8 space-y-2">
				...
				<h2 className='uppercase text-2xl lg:text-6xl tracking-tighter font-bold bg-orange-500 py-2'>Deal Ends November 1st, 2024</h2>
			</div>
...
// 			<div className="relative w-full">
				...
				// />	
// 				{/* Desktop Hero */}
// 				<div className="pl-2 lg:pl-12 max-w-2xl lg:py-8 2xl:py-12 absolute top-0 lg:space-y-2 xl:space-y-8 2xl:space-y-24 text-white bg-gradient-to-r from-black/90">
// 					<h1 className="font-arialBlack text-5xl lg:text-7xl xl:text-8xl 2xl:text-9xl tracking-tight leading-hero max-w-0 lg:max-w-xs ">Renzo Gracie Houston</h1>
// 					<div className="hidden lg:block max-w-xs 2xl:max-w-lg text-base lg:text-lg 2xl:text-4xl space-y-2 2xl:space-y-8">
// 						<p className="font-garet">Brazilian Jiu-Jitsu, Wrestling, Muay Thai, and more in Houston.</p> 
...
// 					<p className="font-garet text-xl">Brazilian Jiu-Jitsu, Wrestling, Muay Thai, and more in Houston.</p> 
...
// 				{/* Section Break */}
// 				<div className="w-full bg-white h-fit -translate-y-0 lg:-translate-y-6 grid grid-cols-1 lg:grid-cols-3 gap-6 px-12 py-6 lg:py-4 text-xl text-black">
...
// 					<div className="grid grid-rows-8 grow-0">
// 						<div className="flex flex-col items-center justify-between">
// 							<MMA  className="w-24 h-24 pb-4"/>
// 							<h4 className="row-span-1 text-center text-black font-arialBlack">
// 								Wrestling & Muay Thai
// 							</h4>
// 							<p className="hidden lg:block row-span-2 text-sm 2xl:text-xl text-center font-garet">
// 							Additional class opportunities that bolster and improve the necessary skills and conditioning for BJJ. Choose from a variety of different martial arts.
// 							</p>
// 							<p className="block lg:hidden row-span-2 text-sm text-center font-garet">
// 							Combine wrestling, muay thai and jiu jitsu for the ultimate workout.
// 							</p>
// 							<Link className="hidden lg:block" href="/programs">
// 								<div className="row-span-1 flex justify-center gap-1 hover:scale-110 duration-150">
// 									<p className="text-sm 2xl:text-base text-black font-arialBlack">Read More</p>
...
// 				{/* Menu Grid */}
// 				<div className="flex flex-col lg:grid lg:grid-cols-4 py-6 gap-6 w-2/3 lg:w-5/6 2xl:w-3/4">
...
// 						</div>
// 					</Link>
// 					<Link className="col-span-1" href="https://renzograciehouston.sites.zenplanner.com/retail.cfm">	
// 						<div className="card ease-in-out duration-500 h-64 lg:h-72 2xl:h-96 bg-white hover:bg-header text-black hover:text-white outline outline-1 outline-black rounded-md flex flex-col justify-between">
// 							<Image
// 								className='h-5/6 rounded-md object-cover saturate-125'
// 								src={ShopImage}
