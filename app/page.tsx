...
export default function Page() {
	useEffect(() => {
		...
		var countDownDate = new Date("Apr 30, 2024 23:59:00").getTime();
	...
	return (
		<>	
			...
			<div className="flex flex-col justify-around text-center bg-black font-garet text-white pt-8 space-y-2">
				...
				<h2 className='uppercase text-2xl lg:text-6xl tracking-tighter font-bold bg-orange-500 py-2'>Deal Ends April 30th, 2024</h2>
			</div>
